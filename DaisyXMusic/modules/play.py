        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    # print(e)
                    await lel.edit(
                        f"<i>❗ Flood Wait Error ❗Mikey VC Assistant couldn't join your group due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @MikeyVCBot to your Group and try again</i>",
                    )
    try:
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    # print(e)
                    await lel.edit(
                        f"<i>❗ Flood Wait Error ❗Mikey VC Assistant couldn't join your group! Make sure Mikey VC Assistant is not banned in group."
                        "\n\nOr manually add @MikeyVCBot to your Group and try again</i>",
                    )
    try:
        await USER.get_chat(chid)
...
async def lol_cb(b, cb):
    ...
    if cb.from_user.id != useer_id:
        ...
        return
    await cb.message.edit("Mikey Is Getting Ready To Play Music, Hang On😃.....")
    x=int(x)
    try:
